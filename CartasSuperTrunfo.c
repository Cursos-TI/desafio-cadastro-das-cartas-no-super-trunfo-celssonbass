...
int main() {
    ...
    float densidadePopulacional; // VARIAVEL QUE ARMAZENA A DENSIDADE POPULACIONAL
    float pibPerCapta; // VARIAVEL QUE ARMAZENA O PIB PER CAPITA
    ...
    printf("Densidade Populacional: %f\n", densidadePopulacional); // EXIBE DENSIDADE POPULACIONAL
    printf("PIB Per Capita: %f reais\n", pibPerCapta); // EXIBE O PIB PER CAPTA
